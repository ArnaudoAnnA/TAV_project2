...
tau_d = 0.5; %differential (open differential, the toque is equally distribuited among left and right)
pt_del = 20e-3;
tau_torque = 50e-3;
...
%equivalent mass
me = kerb_w + (tau_g^2*tau_d^2)/(wheel_radius^2) + 4/(wheel_radius^2);
